...
\twocolumn[
\icmltitle{A Prediction and Analysis of the interplay between Graduates and Salary Prospects in the STEM Field}
...
To find the optimal hyperparameter we used two well-established methods, the PACF and information-based criteria as descriped in \citep{pacf}. Particularly the AIC and 
