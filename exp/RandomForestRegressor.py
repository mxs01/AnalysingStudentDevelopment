...
from . import graduates

import matplotlib.pyplot as plt

def RandomForestRegressorPrediction():
    ...
    figure_path = os.path.join(directory_path, 'RandomForestRegressorPrediction.pdf')

    # Use the full path when saving the figure
    plt.savefig(figure_path, format='pdf')
    
    # Close the figure if it is no longer needed to free memory
    plt.close()
